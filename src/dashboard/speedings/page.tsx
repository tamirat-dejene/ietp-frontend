  ...
  return (
    <div className="dashboard-content-container">
      <header className="content-header">
        ...
        <SearchBox searchQuery={searchQuery} setSearchQuery={setSearchQuery} placeholder="Search for a plate #" background='#FFFFFF' stroke='none' />
      </header>
      ...
      <ReportTable searchQuery={searchQuery} setSearchQuery={setSearchQuery}/>
    </div>
  )
}
